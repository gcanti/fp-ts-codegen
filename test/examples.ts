...
export const Option = M.data(
  'Option',
  [M.parameterDeclaration('A')],
  [M.constructor('None'), M.constructor('Some', [M.member(M.ref('A'))])]
)
...
export const Maybe = M.data(
  'Maybe',
  [M.parameterDeclaration('A')],
  [M.constructor('Nothing'), M.constructor('Just', [M.member(M.ref('A'), some('value'))])]
)
...
export const Either = M.data(
  ...
  [M.constructor('Left', [M.member(M.ref('E'))]), M.constructor('Right', [M.member(M.ref('R'))])]
)
...
export const Constrained = M.data(
  ...
  [M.constructor('Fetching'), M.constructor('GotData', [M.member(M.ref('A'))])]
)
